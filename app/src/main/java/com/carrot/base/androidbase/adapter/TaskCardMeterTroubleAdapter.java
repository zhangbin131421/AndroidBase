 ...
 */
public class TaskCardMeterTroubleAdapter extends RecyclerView.Adapter<TaskCardMeterTroubleAdapter
        .DataObjectHolder> {

    private static String LOG_TAG = "TaskCardResolveRecordAdapter";
    private List<MeterTroubleResult> mDataset;
    ...
    public TaskCardMeterTroubleAdapter(List<MeterTroubleResult> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_row_fragment_task_list_meter_trouble, parent, false);
    ...
    public void addItem(MeterTroubleResult dataObj, int index) {
    ...
    // Add a list of items
    public void addAll(List<MeterTroubleResult> list) {
        if(list != null){
            mDataset.addAll(list);
        }else{
            mDataset.addAll(new ArrayList<MeterTroubleResult>());
        }
        notifyDataSetChanged();
    }

    public MeterTroubleResult getItem(int index){
