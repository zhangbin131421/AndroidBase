...
import com.carrot.base.androidbase.adapter.TaskCardEarthResistanceTestAdapter;
...
public class TaskListEarthResistanceTestActivity extends TaskListBaseActivity {

    @RestService
    EarthResistanceTestClient earthResistanceTestClient;

    private TaskCardEarthResistanceTestAdapter mAdapter;
    ...
    void newAdapter(){
        mAdapter = new TaskCardEarthResistanceTestAdapter(new ArrayList<EarthResistanceTestResult>());
    }
    ...
    void uiInit(){
        ...
        ((TaskCardEarthResistanceTestAdapter) mAdapter).setOnItemClickListener(new TaskCardEarthResistanceTestAdapter
                .MyClickListener() {
            @Override
    ...
    List<EarthResistanceTestResult> getResultListFromServer(){
        return earthResistanceTestClient.getByUserId(userPrefs.id().get(), status.equals("已完成") ? 1 : 0);
    }
