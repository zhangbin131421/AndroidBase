 ...
 */
public class TaskCardBusinessAuditeAdapter extends RecyclerView.Adapter<TaskCardBusinessAuditeAdapter
        .DataObjectHolder> {

    private static String LOG_TAG = "TaskCardBusinessAuditeAdapter";
    private List<BusinessAuditeResult> mDataset;
    ...
    public TaskCardBusinessAuditeAdapter(List<BusinessAuditeResult> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_row_fragment_task_list_business_audite, parent, false);
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        BusinessAuditeResult taskBaseVo = mDataset.get(position);
    ...
    public void addItem(BusinessAuditeResult dataObj, int index) {
    ...
    // Add a list of items
    public void addAll(List<BusinessAuditeResult> list) {
        if(list != null){
            mDataset.addAll(list);
        }else{
            mDataset.addAll(new ArrayList<BusinessAuditeResult>());
        }
        notifyDataSetChanged();
    }

    public BusinessAuditeResult getItem(int index){
