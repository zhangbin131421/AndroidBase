...
public class TotalPerformanceTestResult {
    ...
    public MultiValueMap<String, Object> parseToMultiValueMap() throws UnsupportedEncodingException {
        ...
        rtn.add(TotalPerformanceTestResult.AssignmentTime, this.assignmentTime.getBytes("UTF-8"));
        rtn.add(TotalPerformanceTestResult.CreatedTime, this.createdTime.getBytes("UTF-8"));
        ...
        rtn.add(TotalPerformanceTestResult.BeginHandleTime, this.beginHandleTime.getBytes("UTF-8"));
        rtn.add(TotalPerformanceTestResult.ElectricityA, this.electricityA.getBytes("UTF-8"));
        rtn.add(TotalPerformanceTestResult.ElectricityBPic, this.ElectricityBPic == null ? "" : this.ElectricityBPic.getBytes("UTF-8"));
        rtn.add(TotalPerformanceTestResult.ElectricityC, this.electricityC.getBytes("UTF-8"));
        rtn.add(TotalPerformanceTestResult.ElectricityDPic, this.electricityDPic == null ? "" : this.electricityDPic.getBytes("UTF-8"));
        rtn.add(TotalPerformanceTestResult.OperateTime, this.operateTime.getBytes("UTF-8"));
        rtn.add(TotalPerformanceTestResult.TestTime, this.testTime.getBytes("UTF-8"));
