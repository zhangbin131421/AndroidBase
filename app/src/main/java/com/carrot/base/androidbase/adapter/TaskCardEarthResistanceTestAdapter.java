 ...
 */
public class TaskCardEarthResistanceTestAdapter extends RecyclerView.Adapter<TaskCardEarthResistanceTestAdapter
        .DataObjectHolder> {

    private static String LOG_TAG = "TaskCardResolveRecordAdapter";
    private List<EarthResistanceTestResult> mDataset;
    ...
    public TaskCardEarthResistanceTestAdapter(List<EarthResistanceTestResult> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_row_fragment_task_list_earth_resistance_test, parent, false);
    ...
    public void addItem(EarthResistanceTestResult dataObj, int index) {
    ...
    // Add a list of items
    public void addAll(List<EarthResistanceTestResult> list) {
        if(list != null){
            mDataset.addAll(list);
        }else{
            mDataset.addAll(new ArrayList<EarthResistanceTestResult>());
        }
        notifyDataSetChanged();
    }

    public EarthResistanceTestResult getItem(int index){
