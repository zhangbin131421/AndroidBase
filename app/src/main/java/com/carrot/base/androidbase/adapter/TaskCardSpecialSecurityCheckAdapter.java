 ...
 */
public class TaskCardSpecialSecurityCheckAdapter extends RecyclerView.Adapter<TaskCardSpecialSecurityCheckAdapter
        .DataObjectHolder> {

    private static String LOG_TAG = "TaskCardResolveRecordAdapter";
    private List<SpecialSecurityCheckResult> mDataset;
    ...
    public TaskCardSpecialSecurityCheckAdapter(List<SpecialSecurityCheckResult> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_row_fragment_task_list_special_security_check, parent, false);
...
//        holder.scope.setText(taskBaseVo.);
    ...
    public void addItem(SpecialSecurityCheckResult dataObj, int index) {
    ...
    // Add a list of items
    public void addAll(List<SpecialSecurityCheckResult> list) {
        if(list != null){
            mDataset.addAll(list);
        }else{
            mDataset.addAll(new ArrayList<SpecialSecurityCheckResult>());
        }
        notifyDataSetChanged();
    }

    public SpecialSecurityCheckResult getItem(int index){
