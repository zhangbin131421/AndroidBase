...
//            view = ImageUtils.getImageViewForForm(context, resources, bitmap, null);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//
...
//    }
//
//    public static View getImageViewForForm(Context context, Resources resources, Bitmap bitmap, final PhotoInfo pi){
//
...
//                Log.i("sslog", "delete button clicked, " + (pi == null ? "" : pi.getPhotoPath()));
//            }
//        });
//
