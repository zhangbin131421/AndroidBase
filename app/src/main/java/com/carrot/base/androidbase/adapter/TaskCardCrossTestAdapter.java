 ...
 */
public class TaskCardCrossTestAdapter extends RecyclerView.Adapter<TaskCardCrossTestAdapter
        .DataObjectHolder> {

    private static String LOG_TAG = "TaskCardResolveRecordAdapter";
    private List<CrossTestResult> mDataset;
    ...
    public TaskCardCrossTestAdapter(List<CrossTestResult> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_row_fragment_task_list_cross_test, parent, false);
    ...
    public void addItem(CrossTestResult dataObj, int index) {
    ...
    // Add a list of items
    public void addAll(List<CrossTestResult> list) {
        if(list != null){
            mDataset.addAll(list);
        }else{
            mDataset.addAll(new ArrayList<CrossTestResult>());
        }
        notifyDataSetChanged();
    }

    public CrossTestResult getItem(int index){
