 ...
 */
public class TaskCardVoltageMeasurementAdapter extends RecyclerView.Adapter<TaskCardVoltageMeasurementAdapter
        .DataObjectHolder> {

    private static String LOG_TAG = "TaskCardResolveRecordAdapter";
    private List<VoltageMeasurementResult> mDataset;
    ...
    public TaskCardVoltageMeasurementAdapter(List<VoltageMeasurementResult> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_row_fragment_task_list_voltage_measurement, parent, false);
    ...
    public void addItem(VoltageMeasurementResult dataObj, int index) {
    ...
    // Add a list of items
    public void addAll(List<VoltageMeasurementResult> list) {
        if(list != null){
            mDataset.addAll(list);
        }else{
            mDataset.addAll(new ArrayList<VoltageMeasurementResult>());
        }
        notifyDataSetChanged();
    }

    public VoltageMeasurementResult getItem(int index){
