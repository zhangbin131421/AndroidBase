...
public class CrossTestResult {
    ...
    public MultiValueMap<String, Object> parseToMultiValueMap() throws UnsupportedEncodingException {
        ...
        rtn.add(CrossTestResult.EarthDistancePic, this.earthDistancePic == null ? "" : this.earthDistancePic.getBytes("UTF-8"));
        rtn.add(CrossTestResult.CrossDistancePic, this.crossDistancePic == null ? "" : this.crossDistancePic.getBytes("UTF-8"));
