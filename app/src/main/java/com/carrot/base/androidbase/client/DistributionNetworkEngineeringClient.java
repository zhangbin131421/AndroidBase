 ...
 */
@Rest(rootUrl = "http://119.90.140.156:8087/api/DistributionNetworkEngineering",
        converters = {MappingJackson2HttpMessageConverter.class,
                StringHttpMessageConverter.class,FormHttpMessageConverter.class,
                ByteArrayHttpMessageConverter.class})
public interface DistributionNetworkEngineeringClient extends RestClientErrorHandling {
    ...
    @Accept(MediaType.APPLICATION_JSON)
    List<DistributionNetworkEngineeringResult> getByUserId(@Path int userId, @Path int isHandled);
