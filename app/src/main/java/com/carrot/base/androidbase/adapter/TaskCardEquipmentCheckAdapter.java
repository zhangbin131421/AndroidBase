 ...
 */
public class TaskCardEquipmentCheckAdapter extends RecyclerView.Adapter<TaskCardEquipmentCheckAdapter
        .DataObjectHolder> {

    private static String LOG_TAG = "TaskCardResolveRecordAdapter";
    private List<EquipmentCheckResult> mDataset;
    ...
    public TaskCardEquipmentCheckAdapter(List<EquipmentCheckResult> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_row_fragment_task_list_equipment_check, parent, false);
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        EquipmentCheckResult taskBaseVo = mDataset.get(position);
    ...
    public void addItem(EquipmentCheckResult dataObj, int index) {
    ...
    // Add a list of items
    public void addAll(List<EquipmentCheckResult> list) {
        if(list != null){
            mDataset.addAll(list);
        }else{
            mDataset.addAll(new ArrayList<EquipmentCheckResult>());
        }
        notifyDataSetChanged();
    }

    public EquipmentCheckResult getItem(int index){
