...
import com.carrot.base.androidbase.adapter.TaskCardCollectResolveTroubleAdapter;
...
public class TaskListCollectResolveTroubleActivity extends TaskListBaseActivity {

    @RestService
    CollectResolveTroubleClient collectResolveTroubleClient;

    private TaskCardCollectResolveTroubleAdapter mAdapter;
    ...
    void newAdapter(){
        mAdapter = new TaskCardCollectResolveTroubleAdapter(new ArrayList<CollectResolveTroubleResult>());
    }
    ...
    void uiInit(){
        ...
        ((TaskCardCollectResolveTroubleAdapter) mAdapter).setOnItemClickListener(new TaskCardCollectResolveTroubleAdapter
                .MyClickListener() {
            @Override
    ...
    List<CollectResolveTroubleResult> getResultListFromServer(){
        return collectResolveTroubleClient.getByUserId(userPrefs.id().get(), status.equals("已完成") ? 1 : 0);
    }
